...
class HPSP_Frontend {
	...
	public static function enqueue() : void {
		...
		wp_enqueue_style( 'hpsp-frontend', HPSP_URL . 'assets/css/social-proof.css', [], HPSP_VERSION );
		wp_enqueue_script( 'hpsp-frontend', HPSP_URL . 'assets/js/social-proof.js', [], HPSP_VERSION, true );
	...
	public static function render_root() : void {
		...
		$vars = [
			...
			'--hpsp-border-color' => $settings['border_color'],
			'--hpsp-border-width' => absint( $settings['border_width'] ) . 'px',
